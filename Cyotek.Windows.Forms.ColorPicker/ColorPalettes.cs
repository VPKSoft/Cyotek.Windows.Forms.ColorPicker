...
namespace Cyotek.Windows.Forms
{
  ...
  public static class ColorPalettes
  {
    ...
    public static ColorEntryCollection HexagonPalette
    {
      get
      {
        return new ColorEntryCollection(new[]
                                   {
    ...
    public static ColorEntryCollection NamedColors
    {
      get
      {
        List<Color> results;
        ...
        return new ColorEntryCollection(results);
      }
    }

    public static ColorEntryCollection Office2010Standard
    {
      get
      {
    ...
    public static ColorEntryCollection PaintPalette
    {
      get
      {
        return new ColorEntryCollection(new[]
    ...
    public static ColorEntryCollection QbColors
    {
      get
      {
        return new ColorEntryCollection(new[]
    ...
    public static ColorEntryCollection StandardPalette
    {
      get
      {
        return new ColorEntryCollection(new[]
    ...
    public static ColorEntryCollection WebSafe
    {
      get
      {
        return new ColorEntryCollection(new[]
    ...
    public static ColorEntryCollection GetPalette(ColorPalette palette)
    {
      ColorEntryCollection result;
      ...
      switch (palette)
      {
        ...
        case ColorPalette.None:
          result = new ColorEntryCollection();
          break;
    ...
    public static ColorEntryCollection ScaledPalette(IEnumerable<Color> topRow)
    {
